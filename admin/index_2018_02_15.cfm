...
<div id="main">
  ...
  <nav class="navbar sticky-top">
    ...
    <script type="text/javascript" src="../js/pieceLabel.js"></script>
...
ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9","ee6b7db5b51705a13dc2339db3edaf6d"];</script>
    ...
    function resizeSideBar(width){
      ...
      if (width === "0px") {
        $('.sidebar-nav').animateCss('fadeOut',function(){
          $('.sidebar-nav').hide();
        });
      }
      else{
        $('.sidebar-nav').show();
        $('.sidebar-nav').animateCss('fadeIn');
      }
    }
    ...
    $(document).ready(function() {
      transformicons.add('.tcon'); transformicons.toggle('.tcon');
